...
** moe-theme
   * Homepage: [[https://github.com/kuanyui/moe-theme.el]]
   ...
   #+END_SRC
** Fix Moe ignoring Powerline
   Moe doesn't set Powerline faces unsless using powerline-moe-theme.
   #+BEGIN_SRC emacs-lisp
     (defun hamster/set-mode-line-faces ()
